...
model_bfm_mat = sio.loadmat('data/raw/01_MorphableModel.mat')
model_infor_mat = sio.loadmat('data/3ddfa/model_info.mat')
expression_mat = sio.loadmat("data/3ddfa/Model_Expression.mat")
tri_mouth_mat = sio.loadmat("data/3ddfa/Model_tri_mouth.mat")
face_contour_mat = sio.loadmat("data/3ddfa/Model_face_contour_trimed.mat")
nose_hold_mat = sio.loadmat("data/3ddfa/Modelplus_nose_hole.mat")
keypoint_parallel = sio.loadmat("data/3ddfa/Modelplus_parallel.mat")
bfm_uv_mat = sio.loadmat("data/stn/BFM_UV.mat")
...
shapeMU = model_bfm_mat['shapeMU'][trimIndex_f, :]
list_for_model.append(shapeMU)
shapePC = model_bfm_mat['shapePC'][trimIndex_f, :]
list_for_model.append(shapePC)
shapeEV = model_bfm_mat['shapeEV']
list_for_model.append(shapeEV)
texMU = model_bfm_mat['texMU'][trimIndex_f, :] 
list_for_model.append(texMU)
texPC = model_bfm_mat['texPC'][trimIndex_f, :]
list_for_model.append(texPC)
texEV = model_bfm_mat['texEV']
list_for_model.append(texEV)
tri = model_infor_mat['tri']
list_for_model.append(tri)
kpt_ind = model_infor_mat['keypoints']
list_for_model.append(kpt_ind)




#TM-ANCHOR: create model infor
list_for_model_infor.append(
    model_infor_mat['keypoints']
)

list_for_model_infor.append(
    model_infor_mat['trimIndex']
)

list_for_model_infor.append(
    model_infor_mat['symlist']
)

list_for_model_infor.append(
    model_infor_mat['symlist_tri']
)

list_for_model_infor.append(
    model_bfm_mat['segbin'][trimIndex.flatten() - 1, :].T # start index in matlab is 1 not 0 
)
list_for_model_infor.append(
    model_infor_mat['segbin_tri'].T
)
        

# TM-ANCHOR: load expression 
list_for_model.append(
    expression_mat['mu_exp']
)

list_for_model.append(
    expression_mat['w_exp']
)

list_for_model.append(
    expression_mat['sigma_exp']
)
...
list_for_model_infor.append(
    face_contour_mat['face_contour']
)

list_for_model_infor.append(
    face_contour_mat['face_contour_line']
)

list_for_model_infor.append(
    face_contour_mat['face_contour_front']
)

list_for_model_infor.append(
    face_contour_mat['face_contour_front_line']
)

# TM-ANCHOR: nose hole
list_for_model_infor.append(
    nose_hold_mat['nose_hole']
)

list_for_model_infor.append(
    nose_hold_mat['nose_hole_right']
)

list_for_model_infor.append(
    nose_hold_mat['nose_hole_left']
)

# TM-ANCHOR: parallel for key points 
list_for_model_infor.append(
    keypoint_parallel['parallel']
)

list_for_model_infor.append(
    keypoint_parallel['parallel_face_contour']
)
...
list_for_model[11] = tm_inner 
list_for_model_infor[6] = tm_inner 
...
# save
BFM_model = {} 
BFM_model['model'] = np.array([[list_for_model]], dtype= 'object')
...
BFM_infor = {}
BFM_infor['model_info'] = np.array([[list_for_model_infor]], dtype='object')
